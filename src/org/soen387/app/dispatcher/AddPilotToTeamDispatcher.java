...
import org.soen387.domain.command.AddPilotToTeamCommand;

public class AddPilotToTeamDispatcher extends Dispatcher {
	
	@Override
	public void execute() throws ServletException, IOException {
		try {
			new AddPilotToTeamCommand(myHelper).execute();
